...
const ForgotPasswordPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!email.trim()) {
      ...
      // ผ่านการตรวจสอบ (จำลองการส่ง)
      console.log('Request Password Reset for:', email);
      
      // 1. แจ้งเตือน (โค้ดจะหยุดรอตรงนี้จนกว่าจะกด OK)
      alert(`ระบบส่งลิงก์รีเซ็ตรหัสผ่านไปที่ ${email} แล้ว`);

      // 2. เมื่อกด OK แล้ว ให้เปลี่ยนไปหน้า createpassword
