...
export default function DormitoryLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans text-gray-800 bg-lime-50">
      ...
      <header className="bg-white px-6 py-3 flex justify-between items-center shadow-sm relative z-20">
        ...
        <div className="relative">
          ...
          >
            ...
            <span className="font-medium text-lg uppercase border-b-2 border-emerald-900">XXXXXXXX</span>
      ...
      <div className="bg-emerald-900 text-white py-2 px-6 shadow-md z-10">
        <div className="container mx-auto">
            <h1 className="text-lg font-medium tracking-wide">Dormitory</h1>
        </div>
      </div>
      ...
      {/* --- 4. Footer --- */}
      <footer className="bg-emerald-900 text-white py-1 mt-auto">
